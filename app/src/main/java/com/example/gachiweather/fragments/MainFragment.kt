...
const val API_KEY = "ea0638daae2e4260917200251221410"
...
class MainFragment : Fragment() {
    ...
    private fun init() = with(binding){
        fLocationClient = LocationServices
        ...
        ibSearch.setOnClickListener(){
            DialogManager.searchByNameDialog(requireContext(),
    ...
    private fun checkLocation(){
        if(isLocationEnabled()){
            ...
            DialogManager.locationSettingsDialog(requireContext(), object :
    ...
    private fun getLocation(){
        ...
        fLocationClient.getCurrentLocation(
            Priority.PRIORITY_HIGH_ACCURACY, ct.token)
    ...
    private fun permissionListener(){
        pLauncher = registerForActivityResult(
            ...
            Toast.makeText(activity, "Permisssion is $it", Toast.LENGTH_LONG).show()
        }
    }
